...
| 7 | **CARE - Customer Administration** | Java | Manages customer information and data for customer service agents - portal for agents | • Reads customer data from CRM PeopleSoft via Karma<br>• Writes updates via XML<br>• Account information<br>• Service subscriptions<br>• Contact history<br>• Account changes<br>**Note:** On-call support handled by Customer Management Team during off-business hours | Central hub for customer information from PeopleSoft CRM.<br><br>**Example:**<br>• Agent searches "Anna Svensson"<br>• CARE fetches data from PeopleSoft via Karma<br>• Shows: address, phone, active services, billing info<br>• Agent updates customer email<br>• CARE sends update to PeopleSoft via XML |
